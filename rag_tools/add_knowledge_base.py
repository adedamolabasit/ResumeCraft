...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--directory", required=True, help="Path to the directory containing documents")
    parser.add_argument("-s", "--chunk-size", type=int, default=8000, help="Size of each chunk")
    parser.add_argument("-o", "--chunk-overlap", type=int, default=100, help="Overlap size between chunks")
